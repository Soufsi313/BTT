...
@section('content')
    ...
    <section class="min-h-screen bg-white text-zinc-900">
        ...
        <div class="flex min-h-screen">
            ...
            |
            | Le lien "Administrateurs" est automatiquement affiché comme
            | actif grâce à request()->routeIs('admin.administrators.*').
            |
            | Cette rubrique reste réservée au Super Admin conformément
            | aux permissions déjà définies dans l'application.
            |
            |--------------------------------------------------------------------------
            --}}
