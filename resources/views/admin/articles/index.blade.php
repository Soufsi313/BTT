...
@section('content')
    ...
    <section class="min-h-screen bg-white text-zinc-900">
        ...
        <div class="flex min-h-screen">
            ...
            | un seul fichier afin de conserver exactement le même
            | menu sur toutes les pages de l'espace administrateur.
            |
            | Le partial détecte automatiquement la route active.
            | Sur cette page, "Articles" sera donc affiché en rouge.
            |
            |--------------------------------------------------------------------------
            --}}
