    ...
    <section class="min-h-screen bg-white text-zinc-900">
        ...
        <div class="flex min-h-screen">
            ...
            {{-- =====================================================
                 ...
                 Cela garantit que le même menu reste visible sur
            ...
            <div class="min-w-0 flex-1">
                ...
                <div class="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        {{-- Conservation du tri actuellement sélectionné. --}}
                                        ...
                                        <td class="px-5 py-5">
                                            ...
                                            >
                                                ...
                                                @if ($course->trashed())
                                                    ...
                                                    {{-- Le Super Admin peut réactiver
                                                         un cours précédemment supprimé. --}}
